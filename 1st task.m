...
gamma=0.00001;%coefficient associated with the probability of neutralization of the antigen        by antibodies
...
miu_m=0.0;
C_st=814;%making new cells very low so it is cause of death
F_st=rho*C_st/miu_f;
